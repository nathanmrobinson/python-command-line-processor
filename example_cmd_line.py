""" File:        example_cmd_line.py
    ...
    Date:        
    Desctiption: An example of the command line processor with a built in help
                 function.
"""
...
if __name__ == '__main__':
    ...
    print "required_string_argument:", required_string_argument
    print "required_float_argument:", required_float_argument
    print "optional_integer_argument:", optional_integer_argument
    print "optional_boolean_argument:", optional_boolean_argument
    print "optional_enumerated_argument:", optional_enumerated_argument
